...
struct StatTrack {
   ...
   StatTrack() : wins(0), draws(0), losses(0), win_reasons(), match_counts(0) {}
...
template < typename GameType >
std::tuple< StatTrack, StatTrack > Arena::pit(
   GameType &game, int num_sims, bool show_game, bool save_results)
{
   StatTrack stats0;
   StatTrack stats1;
