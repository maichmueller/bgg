...
class RepresenterStrategoTest: public ::testing::Test {
  protected:
   std::map< position_type, token_type > setup_start_0;
   std::map< position_type, token_type > setup_start_1;
   std::map< position_type, token_type > setup_mid_0;
   std::map< position_type, token_type > setup_mid_1;
