...
TEST_F(LogicStrategoTest, LogicStrategoTest_poss_moves_Test) {
    ...
    std::unordered_set<move_type> poss_moves_set_0(poss_moves_0.begin(), poss_moves_0.end());
    std::unordered_set<move_type> poss_moves_set_1(poss_moves_1.begin(), poss_moves_1.end());
//
...
//    }
    ...
    std::unordered_set<move_type> poss_moves_set_mid_0(poss_moves_mid_0.begin(), poss_moves_mid_0.end());
    std::unordered_set<move_type> poss_moves_set_mid_1(poss_moves_mid_1.begin(), poss_moves_mid_1.end());
