...
TEST(PositionTest, PositionTest_BinaryOperators_Ints_4D)
{
   ...
   int_pos< dim > p1_mul_2_2{static_cast< int >(4 * 2.2),
                             static_cast< int >(6 * 2.2),
                             static_cast< int >(7 * 2.2),
                             static_cast< int >(2 * 2.2)};
   int_pos< dim > p1_div_2_2{static_cast< int >(4 / 2.2),
                             static_cast< int >(6 / 2.2),
                             static_cast< int >(7 / 2.2),
                             static_cast< int >(2 / 2.2)};
   ...
   EXPECT_EQ(
      2.2 / p1,
      int_pos< dim >(
         static_cast< int >(2.2 / 4),
         static_cast< int >(2.2 / 6),
         static_cast< int >(2.2 / 7),
         static_cast< int >(2.2 / 2)));
   ...
   EXPECT_EQ(
      p1.invert(std::array{0, 0, 0, 0}, std::array{100, 20, 100, 50}),
      int_pos< dim >(95, 13, 92, 47));
   EXPECT_EQ(
      p1.invert(std::array{-10, 4, 3, 0}, std::array{100, 20, 100, 50}),
      int_pos< dim >(85, 17, 95, 47));
}
