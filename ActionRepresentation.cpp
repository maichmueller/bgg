...
std::vector<pos_t> action_ar_s_copy(64);
std::vector<pos_t> action_ar_m_copy(124);
std::vector<pos_t> action_ar_l_copy(228);
...
const std::vector<move_base_t > ActionRep::action_ar_s = action_ar_s_copy;
const decltype(ActionRep::piece_act_map_s) ActionRep::piece_act_map_s = piece_act_map_s_copy;

const std::vector<move_base_t > ActionRep::action_ar_m = action_ar_m_copy;
const decltype(ActionRep::piece_act_map_m) ActionRep::piece_act_map_m = piece_act_map_m_copy;

const std::vector<move_base_t > ActionRep::action_ar_l = action_ar_l_copy;
