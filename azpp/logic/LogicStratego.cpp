...
const std::map<std::array<int, 2>, int> LogicStratego<Board>::battle_matrix = initialize_battle_matrix();

template <class Board>
std::map<std::array<int, 2>, int> LogicStratego<Board>::initialize_battle_matrix() {
